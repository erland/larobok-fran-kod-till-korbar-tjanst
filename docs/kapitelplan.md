...
- Exempel/case: TaskBoards faktiska GitHub Actions-workflow, `App.test.tsx` med Vitest/React Testing Library, `TaskResourceTest` med CRUD/400/404 mot PostgreSQL Dev Services samt full-stack-smoke-testet.
- Status: helhetsreviderad; frontend- och backendtestdelen synkroniserad med referensimplementationen i revision 31
