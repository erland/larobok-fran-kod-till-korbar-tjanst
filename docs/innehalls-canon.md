...
- Kända osäkerheter/tolkningar:
  ...
  - Frontendteststacken är Vitest + React Testing Library + jsdom; backendtesterna använder `@QuarkusTest` + Rest Assured mot PostgreSQL Dev Services; full-stack verifieras via Docker Compose-smoke-test.
