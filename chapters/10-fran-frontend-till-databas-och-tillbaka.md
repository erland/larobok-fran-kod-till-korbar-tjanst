...
Detta skyddar persistens-lagret mot vissa samtidiga uppdateringar, men TaskBoards HTTP-API exponerar ännu inte versionsfältet till klienten. Webbläsaren har alltså inte ett explicit ETag-/versionsbaserat kontrakt för stale writes. Det är viktigt att hålla isär de två nivåerna.
