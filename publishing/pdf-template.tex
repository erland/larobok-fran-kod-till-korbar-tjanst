...
$else$
% Använd XeLaTeX/fontspec-standardfont om Pagella-OTF inte hittas.
$endif$
...
\usepackage{graphicx}\usepackage{microtype}\usepackage{setspace}\usepackage{parskip}\usepackage{fancyhdr}\usepackage[hidelinks]{hyperref}\usepackage{bookmark}\usepackage{tocloft}\usepackage{ragged2e}\usepackage{xcolor}\usepackage{longtable}\usepackage{booktabs}\usepackage{array}\usepackage{calc}\usepackage{etoolbox}\usepackage{fvextra}\usepackage{mdframed}
$if(highlighting-macros)$
$highlighting-macros$
% Kodblock i PDF: bryt långa rader och ge blocken en diskret tryckvänlig yta.
\DefineVerbatimEnvironment{Highlighting}{Verbatim}{commandchars=\\\{\},breaklines=true,breakanywhere=true,fontsize=\small}
\renewenvironment{Shaded}{%
  \begin{mdframed}[backgroundcolor=black!3,linecolor=black!18,linewidth=0.4pt,roundcorner=1.5pt,innerleftmargin=7pt,innerrightmargin=7pt,innertopmargin=6pt,innerbottommargin=6pt,skipabove=0.8em,skipbelow=0.8em]%
}{\end{mdframed}}
$endif$
...
\renewcommand{\contentsname}{Innehåll}\setcounter{tocdepth}{0}\setcounter{secnumdepth}{-1}\setlength{\cftbeforechapskip}{0.35em}
...
\begin{document}
$if(cover-image)$
\thispagestyle{empty}\noindent\includegraphics[width=\paperwidth,height=0.995\paperheight,keepaspectratio]{$cover-image$}\par\newgeometry{inner=20mm,outer=18mm,top=20mm,bottom=22mm,headsep=5mm,footskip=9mm}
$endif$
